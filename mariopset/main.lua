...
function love.draw()
    ...
    if map.win == 0 then
      ...
      map:render()
        ...
        victoryFont2 = love.graphics.newFont('04B_03__.TTF', 16)
        love.graphics.setFont(victoryFont2)
        love.graphics.printf("You Won!!!", 0, 20, VIRTUAL_WIDTH, 'center')
        love.graphics.printf("Press Enter to continue", 0, 50, VIRTUAL_WIDTH, 'center')
        -- love.event.quit( "restart" )
    end
